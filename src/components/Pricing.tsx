...
const tiers = [
  {
    ...
    price: "$7.77",
    period: "/week",
    description: "Flexible weekly billing for indie creators and artists getting started. Safely covers Google Cloud container & database infrastructure costs.",
    features: [
  ...
  },
  {
    ...
    price: "$47.00",
    period: "/month",
    description: "The ultimate monthly professional tier for working musicians, filmmakers, actors, and writers with robust profit margin over Google Cloud APIs.",
    features: [
